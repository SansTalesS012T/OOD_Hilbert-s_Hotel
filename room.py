...
class Room:
    def __init__(self, room_no, guest_no, arrival_channel="Initial"):
        self.__room_no  = room_no
        self.__guest_no = guest_no
        self.__arrival_channel = arrival_channel #Stored How guest arrived   
    ...
    def set_room_no(self, new_room_no):
        self.__room_no = new_room_no
        
    def get_arrival_channel(self):
        return self.__arrival_channel
...
class RoomList:
    ...
    def get_all_rooms(self) -> list:
        return self.__bptree.get_all_values()
    ...
    def clear(self):
        self.__bptree = BPT.BPTree(self.__bptree.get_root().get_order())
    ...
    def display_rooms_list(self):
        self.__bptree.display_leaves_horizontal()
